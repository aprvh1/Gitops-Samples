...
### Sample 1: Simple Kubernetes Secret Manifest ([`/secret-expressions-in-manifest`](./secret-expressions-in-manifest/))

**The simplest approach** - secret expressions directly in a Kubernetes Secret manifest.

**Where are the secret expressions?**  
→ **[`secret-expressions-in-manifest/secret.yaml`](./secret-expressions-in-manifest/secret.yaml)** - Look in the `stringData` field

```yaml
# secret-expressions-in-manifest/secret.yaml
apiVersion: v1
kind: Secret
stringData:
...
[→ View complete simple example with setup instructions](./secret-expressions-in-manifest/)
...
|----------------|-----------------|
| Using plain Kubernetes YAML | [Sample 1: Secret Expressions in Manifest](./secret-expressions-in-manifest/) |
...
| New to the feature | Start with [Sample 1](./secret-expressions-in-manifest/), it's the simplest |
...
- File: `secret-expressions-in-manifest/secret.yaml`
